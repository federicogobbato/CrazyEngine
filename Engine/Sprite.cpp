...
namespace Engine {
    ...
    {
        // Bottom-left
        m_Square[0].position.x = x;
        m_Square[0].position.y = y;
        m_Square[0].uv.x = 0;
        m_Square[0].uv.y = 1;

        // Bottom-right
        m_Square[1].position.x = x + width;
        m_Square[1].position.y = y;
        m_Square[1].uv.x = 1;
        m_Square[1].uv.y = 1;

        // Top-left
        m_Square[2].position.x = x;
        m_Square[2].position.y = y + height;
        m_Square[2].uv.x = 0;
        m_Square[2].uv.y = 0;

        // Top-right
        m_Square[3].position.x = x + width;
        m_Square[3].position.y = y + height;
        m_Square[3].uv.x = 1;
        m_Square[3].uv.y = 0;
